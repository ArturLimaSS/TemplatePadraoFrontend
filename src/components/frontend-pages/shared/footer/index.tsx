...
const footerLinks = [
  {
    ...
    children: [
      ...
      },
      {
        title: false,
        titleText: 'Kanban',
        link: 'https://OrCloud-react.adminmart.com/apps/kanban',
      },
      {
        title: false,
        titleText: 'Invoice List',
        link: 'https://OrCloud-react.adminmart.com/apps/invoice/list',
      },
      {
        title: false,
        titleText: 'eCommerce',
        link: 'https://OrCloud-react.adminmart.com/apps/ecommerce/shop',
      },
      {
        title: false,
        titleText: 'Chat',
        link: 'https://OrCloud-react.adminmart.com/apps/chats',
      },
      {
        title: false,
        titleText: 'Tickets',
        link: 'https://OrCloud-react.adminmart.com/apps/tickets',
      },
      {
        title: false,
        titleText: 'Blog',
        link: 'https://OrCloud-react.adminmart.com/frontend-pages/blog',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        link: 'https://OrCloud-react.adminmart.com/forms/form-layouts',
      },
      {
        title: false,
        titleText: 'Form Horizontal',
        link: 'https://OrCloud-react.adminmart.com/forms/form-horizontal',
      },
      {
        title: false,
        titleText: 'Form Wizard',
        link: 'https://OrCloud-react.adminmart.com/forms/form-wizard',
      },
      {
        title: false,
        titleText: 'Form Validation',
        link: 'https://OrCloud-react.adminmart.com/forms/form-validation',
      },
      {
        title: false,
        titleText: 'Tiptap Editor',
        link: 'https://OrCloud-react.adminmart.com/forms/form-tiptap',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        link: 'https://OrCloud-react.adminmart.com/tables/basic',
      },
      {
        title: false,
        titleText: 'Fixed Header',
        link: 'https://OrCloud-react.adminmart.com/tables/fixed-header',
      },
      {
        title: false,
        titleText: 'Pagination Table',
        link: 'https://OrCloud-react.adminmart.com/tables/pagination',
      },
      {
        title: false,
        titleText: 'React Dense Table',
        link: 'https://OrCloud-react.adminmart.com/react-tables/dense',
      },
      {
        title: false,
        titleText: 'Row Selection Table',
        link: 'https://OrCloud-react.adminmart.com/react-tables/row-selection',
      },
      {
        title: false,
        titleText: 'Drag n Drop Table',
        link: 'https://OrCloud-react.adminmart.com/react-tables/drag-drop',
      },
    ],
  },
];
        ...
        <Box py="40px" flexWrap="wrap" display="flex" justifyContent="space-between">
          <Stack direction="row" gap={1} alignItems="center">
            ...
            <Typography variant="body1" fontSize="15px">
              All rights reserved by OrCloud.{' '}
            </Typography>
          </Stack>
          <Typography variant="body1" fontSize="15px">
            Produced by{' '}
